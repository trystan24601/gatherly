/**
 * OrgEventCreateForm — form for creating a new DRAFT event.
 *
 * Renders all required and optional event fields with accessible labels.
 * Calls createEvent() on submit. Navigates to /organisation/dashboard on success.
 * Displays API error messages inline.
 */
import { useState } from 'react'
import { Link, useNavigate } from 'react-router-dom'
import { createEvent, type CreateEventPayload } from '../../lib/events'
...
export function OrgEventCreateForm() {
